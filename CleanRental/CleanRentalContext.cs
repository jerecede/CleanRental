...
public partial class CleanRentalContext : DbContext
{
    //public CleanRentalContext()
    //{
    //}

    //public CleanRentalContext(DbContextOptions<CleanRentalContext> options)
    //    : base(options)
    //{
    //}
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Define sequences for auto-incrementing primary keys
